...
The whole wide world will laugh with you.<br>`,
    ...
    `My dream set would be Primus and ween.`,
    `My favorite MTV Unplugged is Alice in Chains.`,
    `You learned about the Mandela effect from vsauce.`,
    `You are drinking bullet proof coffee.`,
    ...
    `With respect to an <a href='https://en.wikipedia.org/wiki/Cephalopod_eye'>octopus eye</a>, our human eyes are inside out.`,
    // > videos
