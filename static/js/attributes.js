...
var attr_lst = [
    ...
    `I inherited <a href="//en.wikipedia.org/wiki/Photic_sneeze_reflex">ACHOO syndrome</a> from my mom.`,
    ...
    `Superheroes either dress up as a character (i.e. Spiderman), or impersonate us humans (i.e. Superman).`,
    `My favorite movie is Borat.`,
    `My favorite 00s comedy is <a href='https://www.imdb.com/title/tt0348333/'>Waiting..</a>.`,
    ...
    `My favorite mixed beverage is a Modelo Negra with a lime ⅙<sup>th</sup>.`,
    ...
    `My favorite monster truck is <a href='https://en.wikipedia.org/wiki/Monster_Mutt'>Monster Mutt</a> because I loved the song 'Who let the dogs out' as a kid.`,
    ...
    `My favorite cs textbook (and perhaps only textbook I have read coved-to-cover) is <a href='https://cseweb.ucsd.edu/~dasgupta/book/index.html'>DPV</a>.`,
...
The whole wide world will laugh with you.<br>`,
    ...
    `My favorite Pink Floyd song is <a href="https://en.wikipedia.org/wiki/Echoes_(Pink_Floyd_song)">Echoes</a> -- specifically, <a href="https://youtu.be/PGwPSPIhohk">Live at Pompeii</a>.`,
    ...
    `WTF Happened In <a href='//mhvx.us/1971'>1971</a>?`,
    ...
    `One man's <a href='//mhvx.us/noise'>noise</a> is another man's signal.`,
